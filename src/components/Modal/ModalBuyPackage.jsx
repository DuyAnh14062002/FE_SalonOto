...
export default function ModalBuyPackage(props) {
  ...
  const handlePayMent = async (e, amount) => {
    e.preventDefault();
    if (
      activeVisaPayment === false &&
      activeVnPay === false &&
      activeZaloPayment === false
    ) {
      ...
      if (activeZaloPayment === true) {
        ...
        if (res?.data?.vnpUrl) {
          ...
          toast.error(
            "Bạn đã mua gói dịch vụ này rồi. Vui lòng chọn mua gói khác"
          );
        }
      } else {
  ...
  return (
    <>
      <Modal show={props.show} onHide={handleHideModal} backdrop="static">
        <Form>
            ...
            <Card.Body md="4">
              ...
              <div className="duration">
                <div
                  className={
                    activeMonth3 === true
                      ? "duration-item 3-month active-month"
                      : "duration-item 3-month"
                  }
                  onClick={HandleActiveMonth3}
                >
                  3 tháng
                </div>
                <div
                  className={
                    activeMonth6 === true
                      ? "duration-item 6-month active-month"
                      : "duration-item 6-month"
                  }
                  onClick={HandleActiveMonth6}
                >
                  6 tháng
                </div>
                <div
                  className={
                    activeMonth12 === true
                      ? "duration-item 12-month active-month"
                      : "duration-item 12-month"
                  }
                  onClick={HandleActiveMonth12}
                >
                  12 tháng
                </div>
              </div>
            ...
            <Card.Body style={{ borderTop: "1px dotted black" }}>
              ...
              <div className="choose-payment">
                ...
                <div
                  ...
                  onClick={HandleActiveVisa}
                >
                  <div
                    className="payment-image"
                    style={{
                      backgroundImage: `url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJ3_8A7yRS7tta-z3lHF1qDm4RSTqtFT6_Yw&usqp=CAU)`,
                    }}
                  ></div>
          ...
          <Modal.Footer>
            ...
            <Button
              variant="primary"
              type="submit"
              onClick={(e) => handlePayMent(e, props.price)}
            >
              Thanh toán
            </Button>
          </Modal.Footer>
