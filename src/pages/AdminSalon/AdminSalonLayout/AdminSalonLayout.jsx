...
export default function AdminSalonLayout({ children }) {
  ...
  const HandleAddSalon = async (e) => {
    ...
    if (res?.data?.tatus && res.data.tatus === "success") {
      ...
      setStatusSalon("true");
      toast.success(
        "Thêm salon thành công.Chào mừng bạn đến trang quản lí salon của bạn"
      );
    }
  };
  return (
          ...
          <Modal backdrop="static" show={show} onHide={handleClose}>
            <Form noValidate>
              <Modal.Header closeButton>
                <Modal.Title>
                  Để bắt đầu quản lí.Vui lòng nhập thông tin Salon của bạn
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <Form.Group
                ...
                <Form.Group className="mt-3">
                  ...
                  <input
                    type="file"
                    onChange={(e) => handleOnChangeBanner(e)}
                  />
                </Form.Group>
              </Modal.Body>
              <Modal.Footer>
