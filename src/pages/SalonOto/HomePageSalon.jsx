...
export default function HomePageSalon() {
  ...
  return (
    <div>
      <HeaderSalon/>
      <div className='banner-salon' style={{backgroundImage : `url(https://bizweb.dktcdn.net/100/437/558/themes/836129/assets/slider_1.jpg?1699270212851)`}}>
         
      </div>
      <div className='search-oto-container'>
        <div className='search-box'>
        <div className='Head-title'>
          <div className='logo-search-oto' style={{
        ...
        <div className='body'>
            <div className='search-key'>
              <span>Từ khóa</span>
              <input className='search-key-input' placeholder='từ khóa...'></input>
            </div>
            <div className='search-trademark'>
              <span>Thương hiệu</span>
              <input className='search-trademark-input' placeholder='Thương hiệu...'></input>
            </div>
      ...
      <div className='list-new-car'>
        ...
        <div className="row">
            <div
              className="col-lg-4 col-md-6 col-12 car-container"   onClick={NavigateDetailCar}
            >
                  ...
                  <div className="salon-content">
                    ...
                    <div className='short-introduce'>
                       ...
                       <div className='Designs-box'>
                           <div className='icon-chair' style={{ backgroundImage : `url(//bizweb.dktcdn.net/100/437/558/themes/836129/assets/tag_icon_2.svg?1699270212851)`}}></div>
                           <span>hatchback</span>
                       </div>
                       <div className='version-box'>
                           <div className='icon-version' style={{ backgroundImage : `url(//bizweb.dktcdn.net/100/437/558/themes/836129/assets/tag_icon_3.svg?1699270212851)`}}></div>
                           <span>1.5 AT</span>
                       </div>     
                    </div>
                  </div>
