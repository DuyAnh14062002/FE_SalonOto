...
export default function ListPackage() {
  ...
  return (
    <>
      ...
      <h3 style={{ textAlign: "center", margin: "20px 0" }}>Danh sách gói dịch vụ</h3>
      <div className='row' style={{padding: "0px 100px"}}>
        {packages && packages.length > 0 && packages.map((item) =>{
          return(
            ...
            <div className='bg-top' style={{backgroundImage : `url(https://nhanhoa.com/templates/images/v2/subtract.png)`}}></div>
            <div className="package-content">
              <div className='package-top'>
                <div className='icon' style={{ backgroundImage: `url(https://nhanhoa.com/templates/images/v2/kim_cuong.png)` }}></div>
