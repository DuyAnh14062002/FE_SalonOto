         ...
         <div className='body-news'>
           <div className='left-news'>
            {news?.length > 0 && news.map((item, index) => {
               return(
                <div className='new-item' onClick={() => handleNavigateDetailNew(item.id)} key={index}>
                  <div className='new-item-image' style={{backgroundImage : `url(${item.thumbnail})`}}></div>
           ...
           <div className='right-news'>
             <div className='extimate-cost-container'>
               ...
               <div className='cost-description'>Giúp bạn tính toán tổng số tiền cần chi trả khi mua ôtô.</div>
               <div className='cost-car-form'>
                 <label className='cost-car-label'>Giá xe</label>
                 <div className='cost-car-input-box'>
                   <input className='cost-car-input' placeholder='Nhập giá xe'></input>
               ...
               <div className='caculate'>Tính toán</div>
             </div>
           </div>
         </div>
       </div>
